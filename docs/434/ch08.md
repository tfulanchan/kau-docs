...
| Corporate Budget | Corporates allocate funds to IT in the annual budget for general profit and loss | No billing to the businesses. No rates to compute. Encourages use of new technologies. | Have to compete with all other budgeted items for funds. Potential for overspending. |
